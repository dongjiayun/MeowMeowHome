    ...
    >
        <slot name="label">
            <view
                ...
                :class="{ 'no-label': !label && !isRequired,alignTop }"
                :style="{
                    width: localLabelWidth,
                    justifyContent: localLabelAlign,
                    color: labelColor,
        ...
        <view class="uni-forms-item__content">
            <slot />
            <view class="uni-forms-item__error" :class="{ 'msg--active': msg ,alignRight }">
                <text>{{ msg }}</text>
            </view>
        </view>
        <!-- #endif -->
